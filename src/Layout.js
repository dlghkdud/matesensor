    ...
    return (
        <div className="header">
            <div className='nav'>
                ...
                <Link to="/mating" className='right' onClick="mating()">Mating</Link>
                <Link to="/matingchat" className='right' onClick="matingchat()">Mating chat</Link>
                <span className='right' onClick="newmating()">New mating</span>
                <Link to='/login' className='right2'>Log in&nbsp;&nbsp;·</Link>
                <Link to='/signup' className='right2'>&nbsp;&nbsp;Sign up</Link>
                <Link to='/my' className='right3'>My</Link>
